---
title: "Tuscany Pyroconvection-Type Forecast -- ICON-2I 2.2 km -- VALID 2026-07-14"
subtitle: "3-hourly, 24 h. Run 2026-07-14 00Z. Method after Castellnou et al. (2022), JGR-Atmos."
...
**Ladder actually used for this run: `noshear`** (5 usable pressure
...
![gated](/Users/cristianofoderi/-softEST/firelab-flammap6_install_0828_2025/pyflam/docs/daily/pyroconv_tuscany_icon2i_gated_2026-07-14.png){width=100%}

## Atmospheric potential -- UPPER BOUND (assumes a pyroCu-capable fire in every cell)

![potential](/Users/cristianofoderi/-softEST/firelab-flammap6_install_0828_2025/pyflam/docs/daily/pyroconv_tuscany_icon2i_potential_2026-07-14.png){width=100%}
...
geopotential, temperature, RH and wind on 5 pressure levels plus the 2 m / 10 m state,
