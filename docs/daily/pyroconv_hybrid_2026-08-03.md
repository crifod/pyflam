...
![Question 1 -- POTENTIAL. Pyroconvection class from the atmosphere alone, no fire-side condition. Upper bound, not an expectation.](pyroconv_tuscany_hybrid_potential_2026-08-03.png){width=100%}
...
![Question 2 -- FUEL-GATED. The same ladder with every cell below 10 MW/m of Byram intensity on the Tuscany .lcp fuels forced to class 0. The expected product.](pyroconv_tuscany_hybrid_gated_2026-08-03.png){width=100%}
...
![Question 3 -- PFT MARGIN. Firepower over each column's own PyroCb Firepower Threshold, log scale pivoting at the criterion. Rings meet the criterion and pass the fuel gate; crosses meet it only because the PFT has degenerated.](pyroconv_tuscany_hybrid_pft_margin_2026-08-03.png){width=100%}
...
![Supporting diagnostic -- DRY-PYROCLOUD DECOUPLING. fireABL/ABL for a reference intense fire. Continuous, no class label.](pyroconv_tuscany_hybrid_decoupling_2026-08-03.png){width=100%}
...
![PREDICTED PLUME TOP. The cost ladder solved for height instead of firepower, for a declared 5 GW fire. Continuous, no class label.](pyroconv_tuscany_hybrid_plumetop_2026-08-03.png){width=100%}
...
Generated by tests/pyroconv_daily.py at pyflam `d27c493+local-changes`, 2026-08-03 10:37 UTC -- frozen with that
